...
<header id="navbar-container" class="fixed top-0 left-0 w-full z-40 transition-all duration-500" x-data="{ openMenu: null }">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings?->is_running_text_active && $settings->running_text_content): ?>
        <div class="text-white py-2.5 overflow-hidden relative w-full shadow-sm border-b border-white/10 z-50 select-none"
            ...
            <div class="flex whitespace-nowrap animate-marquee font-medium text-xs tracking-wide uppercase">
                ...
                <span class="pl-2"><?php echo e($settings->running_text_content); ?></span>
            </div>
        </div>
    ...
    <div id="navbar-main" class="w-full transition-all duration-500 border-b flex items-center py-4"
        <?php if(Route::is('home')): ?> :class="isScrolled ? 'shadow-md border-amber-400/30 bg-[#15406a]' : 'bg-transparent border-transparent'"
        <?php else: ?>
            class="shadow-md border-amber-400/30"
            style="background-color: #15406a;" <?php endif; ?>>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center w-full">
            ...
            <div class="flex items-center gap-3 select-none text-white">
                <img src="<?php echo e($settings && $settings->logo_path
                    ? asset('storage/' . $settings->logo_path)
                    : asset('images/default-logo.png')); ?>"
                    alt="" class="h-10 object-contain" />
                <div class="leading-tight">
                    <span
                        class="font-black text-lg block tracking-tight drop-shadow-md"><?php echo e(\App\Models\WebsiteSetting::first()?->website_name ?? 'BPVP PANGKEP'); ?></span>
                    <span
            ...
            <nav class="hidden lg:flex items-center gap-5 font-semibold text-sm text-white">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $navigationMenu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $title => $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($menu['type'] === 'dropdown'): ?>
                        <div class="relative py-2" @mouseenter="openMenu = '<?php echo e($menu['key']); ?>'"
                            @mouseleave="openMenu = null" @click.away="openMenu = null">

                            <button
                                @click="openMenu = (openMenu === '<?php echo e($menu['key']); ?>' ? null : '<?php echo e($menu['key']); ?>')"
                                ...
                                <svg class="w-3.5 h-3.5 transition-transform duration-200"
                                    :class="openMenu === '<?php echo e($menu['key']); ?>' ? 'rotate-180 text-amber-400' : ''"
                            ...
                            <div x-show="openMenu === '<?php echo e($menu['key']); ?>'"
                                ...
                                class="absolute left-0 mt-2 <?php echo e($menu['width']); ?> bg-white rounded-xl shadow-xl border border-slate-100 py-2 text-slate-800 z-50">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $menu['links']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <a href="<?php echo e($url); ?>"
                                        class="block px-4 py-2 hover:bg-amber-50 hover:text-blue-900 border-l-2 border-transparent hover:border-amber-500 font-semibold transition-all text-xs sm:text-sm"><?php echo e($label); ?></a>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            </div>
                        </div>
                    <?php else: ?>
                        <a href="<?php echo e($menu['url']); ?>"
                            class="text-white/90 hover:text-amber-400 transition-colors drop-shadow-xs"><?php echo e($title); ?></a>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
...
<?php /**PATH C:\Users\HP\Herd\bpvppangkep\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>