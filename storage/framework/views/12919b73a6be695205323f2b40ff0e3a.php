...
<header id="navbar-container" class="fixed top-0 left-0 z-40 w-full transition-all duration-500" x-data="{
        ...
        <div class="relative z-50 w-full select-none overflow-hidden border-b border-white/10 py-2.5 text-white shadow-sm"
            ...
            <div class="animate-marquee items-center whitespace-nowrap text-xs font-medium uppercase tracking-wide">
                ...
                <span class="shrink-0 pr-10">
                    <?php echo e($settings->running_text_content); ?>
    ...
    <div id="navbar-main"
        class="w-full border-b py-3.5 transition-all duration-500
            <?php echo e(Route::is('home') ? '' : 'border-amber-400/30 bg-[#15406a] shadow-md'); ?>"
        <?php if(Route::is('home')): ?> :class="isScrolled
                ? 'border-amber-400/30 bg-[#15406a] shadow-md'
                : 'border-transparent bg-transparent shadow-none'" <?php endif; ?>>
        <div class="mx-auto flex w-full max-w-[1700px] items-center justify-between gap-3 px-3 sm:px-4 lg:px-5 xl:px-6">
            ...
            <a href="/" class="flex shrink-0 select-none items-center gap-2 text-white"
                aria-label="Beranda <?php echo e($settings?->website_name ?? 'BPVP Pangkep'); ?>">
                <img src="<?php echo e($settings?->logo_path ? asset('storage/' . $settings->logo_path) : asset('images/default-logo.png')); ?>"
                    alt="<?php echo e($settings?->website_name ?? ''); ?>" class="h-9 w-auto shrink-0 object-contain xl:h-10">
                ...
                <div class="shrink-0 leading-tight">
                    <span
                        ...
                        <?php echo e($settings?->website_name ?? 'BPVP PANGKEP'); ?>
            ...
            <nav
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $navigationMenu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $title => $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($menu['type'] === 'dropdown'): ?>
                        <div class="relative shrink-0 py-2" @mouseenter="openMenu = '<?php echo e($menu['key']); ?>'"
                            @mouseleave="openMenu = null" @click.away="openMenu = null">
                            <button type="button"
                                @click="
                                    openMenu = openMenu === '<?php echo e($menu['key']); ?>'
                                        ? null
                                        : '<?php echo e($menu['key']); ?>'
                                "
                                ...
                                :aria-expanded="openMenu === '<?php echo e($menu['key']); ?>'">
                                ...
                                <svg class="h-3.5 w-3.5 shrink-0 transition-transform duration-200"
                                    :class="openMenu === '<?php echo e($menu['key']); ?>'
                                        ?
                            ...
                            <div x-cloak x-show="openMenu === '<?php echo e($menu['key']); ?>'"
                                ...
                                class="absolute left-0 z-50 mt-2 <?php echo e($menu['width']); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $navigationMenu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $title => $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($menu['type'] === 'dropdown'): ?>
                    <div class="border-b border-white/10">
                        <button type="button"
                            @click="
                                activeTab = activeTab === '<?php echo e($menu['key']); ?>'
                                    ? null
                                    : '<?php echo e($menu['key']); ?>'
                            "
                            ...
                            :class="activeTab === '<?php echo e($menu['key']); ?>'
                                ?
                                'text-amber-400' :
                                ''">
                            <span>
                        ...
                        <div x-cloak x-show="activeTab === '<?php echo e($menu['key']); ?>'" x-collapse
