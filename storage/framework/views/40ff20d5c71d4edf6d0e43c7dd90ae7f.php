<?php $__env->startSection('title', 'Fasilitas - ' . ($settings?->website_name ?? 'BPVP Pangkep')); ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $fasilitas ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <?php
                            $item = (object) $item;
                        ?>
                            ...
                            <div @click="isOpen = true"
                                ...
                                <div>
                                    <div
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($item->foto_fasilitas)): ?>
                                            <img src="<?php echo e(asset('storage/' . $item->foto_fasilitas)); ?>"
                                    ...
                                    <div class="p-5">
                                        ...
                                        <div class="text-xs text-slate-500 leading-relaxed line-clamp-3 font-normal">
                                            <?php echo e(strip_tags($item->deskripsi_fasilitas ?? 'Fasilitas penunjang praktik kerja terstandar.')); ?>
                                ...
                                <div class="flex min-h-full items-center justify-center p-4 sm:p-6 text-center">
                                    ...
                                    <div class="relative transform overflow-hidden rounded-2xl bg-white text-left shadow-2xl transition-all w-full max-w-2xl flex flex-col my-8"
                                        ...
                                        <div
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($item->foto_fasilitas)): ?>
                                                <img src="<?php echo e(asset('storage/' . $item->foto_fasilitas)); ?>"
                                                    alt="<?php echo e($item->nama_fasilitas); ?>" class="w-full h-full object-cover">
                                            <?php else: ?>
                                                <div
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Herd\bpvppangkep\resources\views/informasi/fasilitas.blade.php ENDPATH**/ ?>