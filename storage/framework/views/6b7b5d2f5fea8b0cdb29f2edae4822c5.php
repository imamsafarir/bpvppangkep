<?php $__env->startSection('title', 'Alumni - ' . ($settings?->website_name ?? 'BPVP Pangkep')); ?>
    ...
    <main class="pt-32 pb-16 min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6" x-data="{ activeIndex: null, totalItems: <?php echo e($jumlahAlumni); ?> }"
                    @keydown.escape.window="activeIndex = null">

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $alumni ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <?php
                            $item = (object) $item;
                        ?>
                        ...
                        <div @click="activeIndex = <?php echo e($index); ?>"
                            ...
                            <div
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($item->foto_kegiatan_alumni)): ?>
                                    <img src="<?php echo e(asset('storage/' . $item->foto_kegiatan_alumni)); ?>"
                                        alt="Kegiatan Alumni <?php echo e($item->tahun_angkatan); ?>"
                            ...
                            <div class="p-5 sm:w-3/5 flex flex-col justify-between overflow-hidden">
                                <div class="space-y-2">
                                    <span
                                        ...
                                        <i class="fas fa-calendar-alt text-[9px]"></i> <?php echo e($item->tahun_angkatan); ?>
                                    ...
                                    <div
                                        ...
                                        <?php echo e(strip_tags($item->catatan_alumni ?? 'Informasi penyerapan kerja alumni.')); ?>
                                ...
                                <div class="relative transform overflow-hidden rounded-2xl bg-white text-left shadow-2xl transition-all w-full max-w-2xl flex flex-col my-8 z-20 break-words"
                                    ...
                                    <div class="p-6 sm:p-8 space-y-4">
                                        <div>
                                            <span
                                                ...
                                                <?php echo e($item->tahun_angkatan); ?>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <?php echo $item->catatan_alumni ?? '<p class="italic text-slate-400">Belum ada dokumen catatan tambahan.</p>'; ?>
                                    ...
                                    <div
                                        ...
                                        <span class="text-[10px] sm:text-xs font-bold text-slate-400">
                                            Data <?php echo e($index + 1); ?> dari <?php echo e($jumlahAlumni); ?> Alumni
                                        </span>
                                        <button @click="activeIndex = null"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Herd\bpvppangkep\resources\views/informasi/alumni.blade.php ENDPATH**/ ?>