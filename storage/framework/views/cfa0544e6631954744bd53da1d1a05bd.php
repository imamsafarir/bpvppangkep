...
<?php $__env->startSection('title', 'Standar Pelayanan - ' . ($settings?->website_name ?? 'BPVP Pangkep')); ?>
    ...
    <main class="pt-32 pb-16 min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-3xl border border-slate-200/60 shadow-xs p-6 sm:p-10 space-y-6">
                ...
                <div class="space-y-8">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $standarList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <?php
                            $item = (object) $item;
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <h3 class="font-extrabold text-slate-900 text-sm sm:text-base">
                                        <?php echo e($item->judul_standar ?? 'Standar Pelayanan'); ?></h3>
                                </div>

                                
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($item->file_standar) && !$isImage): ?>
                                    <a href="<?php echo e(asset('storage/' . $item->file_standar)); ?>" target="_blank"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($item->file_standar) && $isImage): ?>
                                <div
                                    ...
                                    <img src="<?php echo e(asset('storage/' . $item->file_standar)); ?>"
                                        alt="<?php echo e($item->judul_standar); ?>"
                                        class="w-full h-auto object-contain max-h-[800px] rounded-lg mx-auto">
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                            
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($item->keterangan_standar)): ?>
                                <div
                                    ...
                                    <?php echo $item->keterangan_standar; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\HP\Herd\bpvppangkep\resources\views/pelayanan-publik/standar.blade.php ENDPATH**/ ?>