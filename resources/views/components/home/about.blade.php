...
<section id="about" class="bg-slate-100/70 py-20 scroll-mt-20 border-t border-slate-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-12 gap-12 items-center">
        <div class="lg:col-span-7 space-y-6">
            {{-- PERBAIKAN: Menambahkan Engine Typewriter Alpine.js Khusus Section About --}}
            ...
            <div class="pt-2 flex flex-wrap gap-4">
                ...
                <a href="https://api.whatsapp.com/send?phone={{ $settings?->whatsapp_number ?? '6285343747243' }}&text=Halo%20PPID%20BPVP%20Pangkep..."
                    target="_blank"
