...
namespace App\Modules\Shortlink\Filament\Pages;
...
{
    protected string $view = 'shortlink::filament.manage-shortlink';
            ...
            ->actions([
                Action::make('qrCode')
                    ...
                    ->modalContent(function (Shortlink $record) {
                        ...
                        return view('shortlink::filament.qr-modal', [
                            'qrBase64'  => $qrBase64,
                            'shortlink' => $record,
                        ]);
                    })
