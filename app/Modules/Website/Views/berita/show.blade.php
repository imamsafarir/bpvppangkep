...
@section('content')
    <main class="pt-32 pb-16 min-h-screen bg-slate-50/50">
        {{-- ðŸ’¡ Lebar dinaikkan ke max-w-7xl agar muat 2 kolom berdampingan --}}
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            {{-- ðŸŸ¢ GRID SYSTEM: Mengatur susunan kiri dan kanan berdampingan di desktop --}}
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                {{-- =========================================================
                     ðŸŸ¢ COLUMN KANAN: BACA BERITA LAINNYA (Lebar: 4 Kolom - STICKY)
                     ========================================================= --}}
